...
StringTable::Key StringTable::key(PyObject* s)
{
...
StringTable::Key StringTable::key_unsafe(PyObject* s)
{
    const std::lock_guard<std::mutex> lock(table_lock);
...
StringTable::Key StringTable::key(unw_word_t pc)
{
    const std::lock_guard<std::mutex> lock(table_lock);
...
StringTable::Key StringTable::key(unw_cursor_t& cursor)
{
    const std::lock_guard<std::mutex> lock(table_lock);
...
std::string& StringTable::lookup(Key key)
{
    const std::lock_guard<std::mutex> lock(table_lock);
