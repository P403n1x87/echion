...
#include <internal/pycore_interpframe_structs.h> // For _PyInterpreterFrame type definition
#elif PY_VERSION_HEX >= 0x030b0000
// Python 3.11-3.13: _PyInterpreterFrame is in pycore_frame.h
#define Py_BUILD_CORE
#include <internal/pycore_frame.h> // For _PyInterpreterFrame type definition
#endif
...
// ------------------------------------------------------------------------
    ...
    [[nodiscard]] static Result<std::reference_wrapper<Frame>> get(PyObject* code_addr);
#ifndef UNWIND_NATIVE_DISABLE
  ...
  private:
    ...
    static inline Key key(PyObject* code);
};
