...
{
  public:
    const char* what() const noexcept override { return "Cannot create stack chunk object"; }
};
...
{
  public:
    StackChunk(PyThreadState* tstate)
      : StackChunk((_PyStackChunk*)tstate->datastack_chunk)
    {
    }
